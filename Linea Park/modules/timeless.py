...
class Timeless(Wallet):
    ...
    def mint(self, retry=0):
        try:
            module_str = f'timeless (mint nft)'

            contract = self.web3.eth.contract(
                address=self.web3.to_checksum_address('0xc577018b3518cD7763D143d7699B280d6E50fdb6'),
                abi='[{"inputs":[],"name":"adoptCat","outputs":[],"stateMutability":"nonpayable","type":"function"}]'
            )
            contract_txn = contract.functions.adoptCat()
